...
},{"ms":48}],12:[function(require,module,exports){
'use strict';
...
},{"./transport":15,"./transports":16,"component-emitter":22,"debug":10,"engine.io-parser":23,"indexof":28,"parsejson":49,"parseqs":50,"parseuri":51}],15:[function(require,module,exports){
'use strict';
...
},{"../transport":15,"component-inherit":9,"debug":10,"engine.io-parser":23,"parseqs":50,"xmlhttprequest-ssl":21,"yeast":66}],20:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../transport":15,"component-inherit":9,"debug":10,"engine.io-parser":23,"parseqs":50,"ws":6,"yeast":66}],21:[function(require,module,exports){
'use strict';
...
},{"./keys":24,"after":1,"arraybuffer.slice":2,"base64-arraybuffer":4,"blob":5,"has-binary":25,"utf8":65}],24:[function(require,module,exports){
"use strict";
...
},{"lodash._baseeach":33}],35:[function(require,module,exports){
(function (global){
'use strict';
...
},{"lodash.keysin":41,"lodash.rest":42}],39:[function(require,module,exports){
'use strict';
...
},{"lodash.rest":42}],40:[function(require,module,exports){
'use strict';
...
},{"lodash._basefilter":34,"lodash._baseiteratee":35}],41:[function(require,module,exports){
(function (global){
'use strict';
...
},{"lodash._reinterpolate":36,"lodash.assigninwith":38,"lodash.keys":45,"lodash.rest":42,"lodash.templatesettings":46,"lodash.tostring":47}],44:[function(require,module,exports){
'use strict';
...
},{"lodash.tostring":47}],45:[function(require,module,exports){
'use strict';
...
},{"lodash._reinterpolate":36,"lodash.escape":44}],47:[function(require,module,exports){
(function (global){
'use strict';
...
},{"strict-uri-encode":63}],54:[function(require,module,exports){
'use strict';
...
},{"./manager":55,"./socket":57,"./url":58,"debug":10,"socket.io-parser":60}],55:[function(require,module,exports){
'use strict';
...
},{"./on":56,"./socket":57,"backo2":3,"component-bind":7,"component-emitter":8,"debug":10,"engine.io-client":12,"indexof":28,"socket.io-parser":60}],56:[function(require,module,exports){
"use strict";
...
},{"./on":56,"component-bind":7,"component-emitter":8,"debug":10,"has-binary":26,"socket.io-parser":60,"to-array":64}],58:[function(require,module,exports){
(function (global){
'use strict';
...
},{"debug":10,"parseuri":51}],59:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./is-buffer":61,"isarray":29}],60:[function(require,module,exports){
'use strict';
...
},{"./binary":59,"./is-buffer":61,"component-emitter":62,"debug":10,"isarray":29,"json3":31}],61:[function(require,module,exports){
(function (global){
"use strict";
...
},{"_process":52,"query-string":53}],68:[function(require,module,exports){
'use strict';

var _require = require('../data/data');

var api = _require.api;
var fbImageUrl = _require.fbImageUrl;
...
module.exports = {
  ...
  initSocket: function initSocket() {
    ...
    if (this.isProduction()) {
      var socket = socketio(api.socket);
      ...
      socket.on(QSEvents.RFID, function () {
  ...
  fetchQSPayload: function fetchQSPayload(url, cb) {
    ...
    var tryUrl = function tryUrl() {
      ...
      promise.then(function (payload) {
        ...
        if (counter >= MAX_TRIES) _this.redirectToLogin();
        counter += 1;
        console.log(err);
  ...
  getFbImageURL: function getFbImageURL(fbid) {
    return fbImageUrl + '/' + fbid + '/picture?type=square&height=180';
  },

  getDisplayAreaEndHTML: function getDisplayAreaEndHTML(data) {
    var compiled = template(this.endHTMLTemplate);
    return compiled({
      data: data,
  ...
  endHTMLTemplate: '<div id="friends-container"><% forEach(data, function(friend) { %><div class="friend-container" data-id="<%= friend.fbid %>"><img src="<%= getFbImageURL(friend.fbid) %>" class="friend-image"></img><img src="<%= friend.url %>" class="porn-image"></img><h2 class="friend-name"><%= friend.name %></h2></div><% }); %></div>'
};

},{"../data/data":67,"jquery":30,"lodash._arrayeach":32,"lodash.template":43,"socket.io-client":54}],69:[function(require,module,exports){
'use strict';
...
$(function () {
  ...
  var endPage = function endPage() {
    var url = data.api.root + '/results?rfid=' + data.rfid;
    helpers.fetchQSPayload(url, function (payload) {
      var list = filter(payload.data, function (friend) {
...
},{"./data/data":67,"./helpers/helpers":68,"jquery":30,"lodash.defer":39,"lodash.filter":40}]},{},[69]);
